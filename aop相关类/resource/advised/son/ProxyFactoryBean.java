...
public class ProxyFactoryBean extends ProxyCreatorSupport
            ...
            for (String name : this.interceptorNames) {
                ...
                if (name.endsWith(GLOBAL_SUFFIX)) {
                    ...
                    if (this.singleton || this.beanFactory.isSingleton(name)) {
                        ...
                        advice = new org.springframework.aop.framework.ProxyFactoryBean.PrototypePlaceholderAdvisor(name);
                    }
    ...
    private List<Advisor> freshAdvisorChain() {
        ...
        for (Advisor advisor : advisors) {
            if (advisor instanceof org.springframework.aop.framework.ProxyFactoryBean.PrototypePlaceholderAdvisor) {
                org.springframework.aop.framework.ProxyFactoryBean.PrototypePlaceholderAdvisor pa = (org.springframework.aop.framework.ProxyFactoryBean.PrototypePlaceholderAdvisor) advisor;
                if (logger.isDebugEnabled()) {
